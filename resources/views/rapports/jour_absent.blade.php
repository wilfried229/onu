...
<div class="container-fluid  dashboard-content">
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">Listes  des absents par jour</h2>
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <h5 class="card-header  bg-danger">Rapports des Utilisateurs</h5>
                        <div class="card-body">
        ...
        $(function () {
            $(".notreDataTable").DataTable({
                ...
                "language": {
                    ...
                    "infoFiltered": "(sur les _MAX_ Utilisateur",
                    "infoPostFix":    "",
                    "thousands":      ",",
