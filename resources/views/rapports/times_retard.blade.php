...
<div class="container-fluid  dashboard-content">
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">Listes  des retard par jour</h2>
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <h5 class="card-header bg-warning">Rapports des Utilisateurs</h5>
                        <div class="card-body">
...
<script>
        ...
        $(function () {
            $(".notreDataTable").DataTable({
                ...
                "autoWidth": true,
                "language": {
                    "lengthMenu": "Afficher _MENU_ Eleves par Page",
                    "zeroRecords": "Aucun résultat",
                    "info": "Page _PAGE_ sur _PAGES_",
                    "infoEmpty": "Aucun  Eleve trouvée",
                    "infoFiltered": "(sur les _MAX_ Eleves",
                    "infoPostFix":    "",
                    "thousands":      ",",
